...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, include = JsonTypeInfo.As.PROPERTY, property = "shapeType", visible = true)
@JsonSubTypes({
})
...
public class Shape   {
  ...
  /**
   **/
  public Shape shapeType(String shapeType) {
  ...
  /**
   **/
  public Shape quadrilateralType(String quadrilateralType) {
  ...
  public boolean equals(Object o) {
    ...
    Shape shape = (Shape) o;
    return Objects.equals(this.shapeType, shape.shapeType) &&
        Objects.equals(this.quadrilateralType, shape.quadrilateralType);
  }
