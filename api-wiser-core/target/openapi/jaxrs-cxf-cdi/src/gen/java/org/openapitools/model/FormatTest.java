...
public class FormatTest   {
  ...
  private java.io.InputStream binary;
 ...
 @Pattern(regexp="/[a-z]/i")  public String getString() {
  ...
  /**
   **/
  public FormatTest binary(java.io.InputStream binary) {
    this.binary = binary;
    return this;
  }
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("binary")
  public java.io.InputStream getBinary() {
    return binary;
  }
  public void setBinary(java.io.InputStream binary) {
    this.binary = binary;
  }
  ...
  @ApiModelProperty(example = "2020-02-02", required = true, value = "")
  @JsonProperty("date")
  @NotNull
