...
public class AdditionalPropertiesClass   {
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("map_with_undeclared_properties_anytype_1")
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("map_with_undeclared_properties_anytype_2")
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("map_with_undeclared_properties_anytype_3")
  ...
  @ApiModelProperty(value = "")
  @JsonProperty("map_with_undeclared_properties_string")
