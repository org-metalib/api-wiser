...
public class MavenBizPom implements ApiWiserTemplateService {

    public static final String TEMPLATE_ID = "api-buddy::maven-module-biz-pom";
    ...
    public String toText(ApiWiserBundle bundle) {
        ...
        return MavenModule.BIZ.enrich(bundle).toXml();
    }
}
