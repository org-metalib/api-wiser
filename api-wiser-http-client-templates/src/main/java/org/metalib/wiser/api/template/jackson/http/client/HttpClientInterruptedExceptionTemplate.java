 ...
 */
public class HttpClientInterruptedExceptionTemplate implements ApiWiserTemplateService {

    /** The name of this template */
    public static final String TEMPLATE_NAME = "http-client-interrupted-exception";
    ...
    static TypeSpec.Builder httpClientInterruptedExceptionTypeBuilder() {
        ...
        return TypeSpec
                ...
                .addMethod(MethodSpec
                        .constructorBuilder()
                        .addModifiers(Modifier.PUBLIC)
                        .addParameter(ParameterSpec.builder(Throwable.class, "throwable").build())
                        .addCode(CodeBlock.builder().addStatement("super(throwable)").build())
                        .build())
                ;
    }
}
