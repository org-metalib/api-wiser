 ...
 */
public class SpringFluxWebClientTemplate implements ApiWiserTemplateService {

    /** The name of this template */
    public static final String TEMPLATE_NAME = "spring-flux-webclient";
    ...
    public String toText(ApiWiserBundle bundle) {
        final var httpClientPackage = bundle.basePackage() + DOT + TEMPLATE_NAME.replace(DASH, DOT);
    ...
    static TypeSpec.Builder httpClientTypeBuilder(ApiWiserBundle bundle) {
        ...
        final var className = bundle.camelizeBaseName() + LOWER_HYPHEN.to(UPPER_CAMEL, TEMPLATE_NAME.replace(DASH, DOT));
